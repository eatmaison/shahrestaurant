    ...
    <div className="mx-auto flex min-h-[60vh] max-w-md flex-col justify-center px-4 py-16">
      {done ? (
        <div className="card-lux animate-fade-up rounded-3xl p-8 text-center shadow-xl shadow-emerald-900/10">
          ...
          <h1 className="font-display mt-5 text-xl font-bold text-slate-900 dark:text-white">{t.email.resetSuccess}</h1>
        ...
        <div className="card-lux animate-fade-up rounded-3xl p-8 shadow-xl shadow-emerald-900/10">
          ...
          <h1 className="font-display mt-4 text-xl font-bold text-slate-900 dark:text-white">{t.email.resetTitle}</h1>
